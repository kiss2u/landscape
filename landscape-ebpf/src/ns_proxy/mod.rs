...
pub fn run() {
    ...
    let target_addr = Ipv4Addr::from_str("223.5.5.5.5").unwrap();
    ...
    landscape_open.maps.rodata_data.outer_ifindex = 9;
    ...
    let mut ns_inner_ingress_hook = TcHookProxy::new(&ns_ingress, 8, TC_INGRESS, 2);
    ...
    let xdp = inner_xdp.attach_xdp(8).unwrap();
