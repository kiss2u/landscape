...
use crate::{
    ...
    reuseport_chain_server::solution::UpstreamSolution,
};
...
impl ResolutionRule {
    pub fn new(config: DNSRuntimeRule, flow_id: u32) -> Self {
        ...
        let resolver = UpstreamSolution::new(flow_id, config.mark, config.resolve_mode.clone());
